...
outputs_inputs_label = ('Liability assumptions driving this optimization, from the Monte Carlo '
                        'simulated IRR of the Step 1 cash-flow schedule (edit the table there '
                        'to change them):')
